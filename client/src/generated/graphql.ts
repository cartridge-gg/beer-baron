                ...
                entity?: {
                    ...
                    models?: Array<
                        ...
                        | {
                              ...
                              start_time?: any | null;
                              status?: any | null;
                              number_players?: any | null;
                              max_players?: any | null;
                              game_length?: any | null;
                              entry_fee?: any | null;
                              password?: any | null;
                          }
                        | { __typename: 'GameTracker' }
                        ...
                        | { __typename: 'ItemBalance' }
                        | { __typename: 'Joined' }
                        | { __typename: 'Ownership'; owner?: any | null }
                        | { __typename: 'Player' }
                        | { __typename: 'TavernAuction' }
                        | { __typename: 'Trade' }
                        | { __typename: 'TradeTrack' }
            ...
            node?: {
                ...
                entity?: {
                    ...
                    models?: Array<
                        ...
                        | { __typename: 'IndulgenceAuctionCount' }
                        | { __typename: 'ItemBalance' }
                        | { __typename: 'Joined'; joined?: any | null }
                        | { __typename: 'Ownership' }
                        | { __typename: 'Player'; name?: any | null }
                        | { __typename: 'TavernAuction' }
                        | { __typename: 'Trade' }
                        | { __typename: 'TradeTrack' }
                        | null
...
export type GetIndulgencesQuery = {
    __typename?: 'World__Query';
    indulgenceAuctionModels?: {
        __typename?: 'IndulgenceAuctionConnection';
        edges?: Array<{
            __typename?: 'IndulgenceAuctionEdge';
            node?: {
                ...
                entity?: {
                    ...
                    models?: Array<
                        ...
                        | {
                              ...
                              status?: any | null;
                              auction_id?: any | null;
                              highest_bid_player_id?: any | null;
                              expiry?: any | null;
                              auction_id_value?: any | null;
                          }
                        | { __typename: 'IndulgenceAuctionCount' }
                        | { __typename: 'ItemBalance' }
                        | { __typename: 'Joined' }
...
export type GetAllBalancesForGameQuery = {
    __typename?: 'World__Query';
    itemBalanceModels?: {
        __typename?: 'ItemBalanceConnection';
        edges?: Array<{
            __typename?: 'ItemBalanceEdge';
            node?: { __typename?: 'ItemBalance'; balance?: any | null; item_id?: any | null; player_id?: any | null } | null;
        } | null> | null;
    } | null;
    playerModels?: {
        __typename?: 'PlayerConnection';
        edges?: Array<{
            __typename?: 'PlayerEdge';
            node?: { __typename?: 'Player'; name?: any | null; player_id?: any | null } | null;
        } | null> | null;
    } | null;
};
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
    return {
        ...
        ): Promise<{ data: GetGamesQuery; extensions?: any; headers: any; status: number }> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.rawRequest<GetGamesQuery>(GetGamesDocumentString, variables, { ...requestHeaders, ...wrappedRequestHeaders }),
                'getGames',
                'query'
            );
        },
        getTrades(
            ...
            requestHeaders?: GraphQLClientRequestHeaders
        ): Promise<{ data: GetTradesQuery; extensions?: any; headers: any; status: number }> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.rawRequest<GetTradesQuery>(GetTradesDocumentString, variables, { ...requestHeaders, ...wrappedRequestHeaders }),
                'getTrades',
                'query'
            );
        },
        getIndulgences(
            variables: GetIndulgencesQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders
        ): Promise<{ data: GetIndulgencesQuery; extensions?: any; headers: any; status: number }> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.rawRequest<GetIndulgencesQuery>(GetIndulgencesDocumentString, variables, { ...requestHeaders, ...wrappedRequestHeaders }),
                'getIndulgences',
                'query'
            );
        },
        getAllBalancesForGame(
            variables: GetAllBalancesForGameQueryVariables,
            requestHeaders?: GraphQLClientRequestHeaders
        ): Promise<{ data: GetAllBalancesForGameQuery; extensions?: any; headers: any; status: number }> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.rawRequest<GetAllBalancesForGameQuery>(GetAllBalancesForGameDocumentString, variables, {
                        ...requestHeaders,
                        ...wrappedRequestHeaders,
                    }),
                'getAllBalancesForGame',
